...
class Profile(ndb.Model):
    ...
    wishlistSession = ndb.StringProperty(repeated=True)
...
class Speaker(ndb.Model):
    ...
    working_experience  = ndb.StringProperty(repeated=True)
    
class SpeakerForm(messages.Message):
    """SpeakerForm -- Speaker outbound form message"""
    name                = messages.StringField(1)
    email               = messages.StringField(2)
    qualification       = messages.StringField(3, repeated=True)
    working_experience  = messages.StringField(4, repeated=True)
